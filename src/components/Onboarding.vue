<template>
  <div v-if="permissions.hasGrantedPermission">
    ...
    <p>
      Zodra het startsein wordt gegeven kun je hier de spelcode invullen en kun
      je met je team aan de slag!
    </p>
  ...
  <div v-else>
    ...
    <p>
      Je krijgt zo een pop up met de vraag of jaap.dev je locatie mag weten.
      Klik op 'Allow'. Ik beloof dat ik er geen misbruik van zal maken.
    </p>
    <button :disabled="permissions.loading" v-on:click="requestPermission()">
      Ik snap het, let's go!
    </button>
  </div>
</template>
